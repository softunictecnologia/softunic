<div class="form-row">
   ...
   <div class="form-group col-md-4">
      ...
      <input type="text" class="form-control money" id="preco" name="preco" value="<?php echo old('preco', esc($extra->preco)); ?>">
   </div>
</div>
...
<div class="form-row mb-2">
   <div class="form-check form-check-flat form-check-primary col-md-3">
      <label for="ativo" class="form-check-label">
         ...
         <input type="checkbox" name="ativo" id="ativo" value="1" <?php if (old('ativo', $extra->ativo)): ?> checked <?php endif; ?>>
         Ativo
      </label>
   </div>
</div>
